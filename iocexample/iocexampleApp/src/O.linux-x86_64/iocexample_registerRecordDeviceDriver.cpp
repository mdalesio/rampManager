...
/* Generated from ../O.Common/iocexample.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_deviocexampleVersion, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "deviocexampleVersion", "devLsoSoft", "devLsoSoftCallback",
...
int iocexample_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/user/pythonLibrary/rampManager/iocexample";
...
/* iocexample_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"iocexample_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(iocexample_registerRecordDeviceDriver(*iocshPpdbbase));
}
