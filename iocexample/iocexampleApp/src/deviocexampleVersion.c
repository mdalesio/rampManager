...
#include "iocexampleVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = iocexampleVERSION;
...
static lsidset deviocexampleVersion = {
    5, NULL, NULL, NULL, NULL, read_string
};
epicsExportAddress(dset,deviocexampleVersion);
